...
@section('content')
    <div class="col-xs-12">
        ...
        @endif
            <form enctype="multipart/form-data" class="form-validate" action="{{route('admin.coupon.update',$coupon->id)}}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control field-validate" autocomplete="off" value="{{ $coupon->code }}" name="code">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description"class="form-control" rows="1">{{ $coupon->descripion }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="description" class="control-label">Jumlah Kupon</label>
                             <input type="text" name="coupon_total" autocomplete="off" onkeypress="return err(this)" value="{{ $coupon->coupon_total }}" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="expired_date" autocomplete="off" readonly value="{{ $coupon->getRawOriginal('expired_date') }}" class="form-control datepicker field-validate">
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <select id="type" name="type" class="form-control">
                                ...
                                <option value="percent" {{($coupon->type == 'percent') ? 'selected' : ''}}>Potongan dalam persen (%)</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="amount" autocomplete="off" onkeypress="return err(this)" value="{{ $coupon->amount }}" class="form-control field-validate">
                            <span id="help-amount" class="help-block">Input berupa bilangan bulat dalam rupiah</span>
                        </div>
                        <div class="maks-amount" style="display: {{$coupon->type == 'percent' ? 'block': 'none'}}">
                            <div class="form-group">
                                <label for="max_amount" class="control-label">Maksimum Potongan</label>
                                <input type="text" name="max_amount" autocomplete="off" onkeypress="return err(this)" value="{{ $coupon->maximum_amount }}" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="min_amount" autocomplete="off" onkeypress="return err(this)" value="{{ $coupon->minimum_amount }}" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <select id="limit" class="form-control" name="limit">
                                ...
                                <option value="1" {{($coupon->user_limit != '0') ? 'selected' : ''}}>Ada batasan</option>
                            </select>
                            <span  class="help-block">total penggunaan kupon dengan kode yang sama untuk setiap pengguna</span>
                        </div>
                        <div class="user-limit" style="display: {{$coupon->user_limit != '0' ? 'block': 'none'}}">
                            <div class="form-group">
                                <label for="user_limit" class="control-label">Jumlah kupon per pengguna<span style="color:red">*</span></label>
                                <input type="text" id="user_limit" name="user_limit" autocomplete="off" onkeypress="return err(this)" value="{{ $coupon->user_limit }}" class="form-control">
